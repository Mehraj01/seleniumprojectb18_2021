...
---> How many types of XPATH are there?
	...
	2- Relative xpath:
		...
		- it allows us to start anywhere in the html code, it is more reliable because we are starting from either the
		   webelement itself OR one of the static parents or childs.
		...
		- Whenever you are having hard time locating with xpath, always try to find a static (stable/non changing) parent
		or child to the desired web element we are trying to locate. And go from there
