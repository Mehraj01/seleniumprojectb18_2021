...
public class DropdownPractices {
    ...
    public void p7_month_dropdown_default_value_test(){
        ...
        // empty List for storing Webelements tp compare it with Expected result

        for (WebElement each : actualDropdownOptions) {

            // we getting Months Webelements text value and storing it inside empty String ArrayList
